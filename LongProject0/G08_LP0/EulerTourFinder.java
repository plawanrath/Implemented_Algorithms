...
public class EulerTourFinder {
	...
	public static List<Edge> findEulerTour(Graph g)  
	{
		...
		HashMap<Vertex,List<Edge>> subTours = new HashMap<Vertex,List<Edge>>();
		for(Edge e : g.edges)
		...
		while(!UnVisitedEdges.isEmpty()) //continue until all edges are visited
		{
			...
			subTours.put(start, tour);
			startEdge = GraphOperations.getUnvisitedEdge(end);
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(verifyTour(g,eulerTour,g.verts.get(82)));
	}
